...
use App\Http\Controllers\Api\V1\Employee\AttendenceController;
use App\Http\Controllers\Api\V1\Employee\ChangePasswordController;
use App\Http\Controllers\Api\V1\Employee\MeetingController;
use App\Http\Controllers\Api\V1\Staff\StaffLoginController;
use App\Http\Controllers\Api\V1\HRM\EmployeeController;
use App\Http\Controllers\Api\V1\HRM\AttendanceController;
use App\Http\Controllers\Api\V1\HRM\SaleMeetingController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // =================================Raw Material========================================
      Route::post('/add/rawmaterial', [RawmaterialController::class, 'raw_material_store']);
     Route::post('/add/rawmaterial/category', [RawmaterialController::class, 'raw_material_category_store']);


     // ===========================Product Section===========================================
       Route::post('/add-category',[ProductController::class,'storeProductCategory']);
       Route::post('/store/supplier', [ProviderController::class, 'storeProvider']);
       Route::get('/get/getProvider', [ProviderController::class, 'getProvider']);
...
// Attendance Routes - using employee guard
Route::middleware('auth:employee')->group(function () {
    // Attendance
    Route::get('/employee-profile', [EmployeProfileController::class, 'profile']);
    Route::post('/employee-change-password', [ChangePasswordController::class, 'changePassword']);
    Route::post('/startAttendance', [AttendenceController::class, 'startAttendance']);
    Route::post('/startBreak', [AttendenceController::class, 'startBreak']);
    Route::post('/endBreak', [AttendenceController::class, 'endBreak']);
    Route::post('/endAttendance', [AttendenceController::class, 'endAttendance']);
    Route::get('/getAttendence', [AttendenceController::class, 'getAttendence']);
    Route::post('/add/distributor', [DistributorController::class, 'distributorRegister']);
    
    // Meetings
    Route::post('/addMeeting', [MeetingController::class, 'meeting']);
    Route::get('/getMeeting', [MeetingController::class, 'getMeeting']);
    //Order
...
Route::get('/get/company', [AddEmployeeController::class, 'company']);
Route::post('/get/department', [AddEmployeeController::class, 'department']);
