            ...
            <b-card>
              ...
              <!-- Email_Address -->
               ...
               <b-col lg="6" md="6" sm="12" class="mb-2">
                ...
                <b-col lg="6" md="6" sm="12" class="mb-2">
    <b-form-group :label="$t('Secondary_Phone')">
      <b-form-input
        label="phone2"
      ...
      ></b-form-input>
          ...
          <!-- Password -->
<b-col md="6" class="mb-2">
  <validation-provider name="Password" :rules="{ required: true, min: 6 }" v-slot="{ valid, errors }">
    ...
    Create_Employee() {
      ...
      self.SubmitProcessing = true;
       ...
       axios.post("/employees", {
          ...
          phone2: this.employee.phone2,  // Add this line
